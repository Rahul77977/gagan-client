...
const HomeDash = () => {
  ...
  useEffect(() => {
    fetch('https://gagan-server.onrender.com/api/v1/auth/counter')
  ...
  return (
    <div style={{ padding: '20px', backgroundColor: '#F3F4F6' }}>
      <h1 style={{ marginBottom: '30px', color: '#111827', fontSize: 'clamp(1.5rem, 5vw, 2.5rem)', fontWeight: 'bold' }}>Admin Dashboard</h1>
      ...
      <div style={{ 
        ...
        <Card title="Total Users" value={dashboardData.totalUsers} icon={<FaUsers />} color="#6366F1" increase="+5%" />
        <Card title="Total Orders" value={dashboardData.totalOrders} icon={<FaShoppingCart />} color="#10B981" increase="+12%" />
        <Card title="Total Rooms" value={dashboardData.totalProducts} icon={<FaBoxes />} color="#F59E0B" increase="+3%" />
        <Card title="Total Sales" value={`$${dashboardData.totalSales}`} icon={<FaDollarSign />} color="#EF4444" increase="+8%" />
      </div>
      ...
      <div style={{ 
        ...
        <div style={{ backgroundColor: 'white', borderRadius: '20px', padding: '20px', boxShadow: '0 10px 30px rgba(0,0,0,0.1)' }}>
          <h2 style={{ marginBottom: '20px', color: '#111827', fontSize: 'clamp(1rem, 4vw, 1.5rem)', fontWeight: 'bold' }}>Product Categories</h2>
